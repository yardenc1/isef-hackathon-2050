  ...
  <div className="container mx-auto px-4">
    ...
    {[
      ...
      },
      {
        ...
        name : 'עידן שחמון',
        img : '/images/edan.jpg',
        desc : 'חוקר דאטה סיינס עם ניסיון בפיתוח מודלים מתקדמים ולמידת מכונה בסביבות מחקר ותעשייה.
מוביל תהליכים מקצה לקצה – מזיהוי בעיה ועד פתרון מבוסס דאטה שמאפשר קבלת החלטות מדויקת יותר.',
      }
    ].map((p, i) => (
