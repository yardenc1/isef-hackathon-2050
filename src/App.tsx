    ...
    {[
      {
        ...
        name : 'ענת רודניה',
        img : '/images/anat.jpg',
        desc : 'מנהלת קהילת הבוגרים של ISEF ומובילת פיתוח עסקי עם ניסיון מוכח בבניית שותפויות, הובלת תהליכים וניהול מערכות מורכבות.',
        ...
        desc : 'מוביל Data Scientist באינטל וחוקר בתחום הסיבתיות ולמידת מכונה, שמתרגם דאטה מורכב מהעולם האמיתי להחלטות עם אימפקט אמיתי.',
        sub : 'יפגוש את המשתתפים במפגש ההזנק ויסייע ביצירת חיבורים והשראה.'
      },
      {
        label : 'מוביל + מנטור',
        name : 'איתי דנה',
        ...
        sub : 'יוביל, ילווה ויפתח כיווני חשיבה כבר ממפגש ההזנק.'
      },
      {
        label : 'מנטורית',
      ...
      },
      {
        ...
        name : 'עידן שחמון',
        img : '/images/edan.jpg',
        desc : 'חוקר דאטה סיינס, Data Science Researcher באוניברסיטת תל אביב.',
        sub : 'מפתח מודלים מתקדמים ולמידת מכונה בסביבות מחקר ותעשייה, ומוביל תהליכים מקצה לקצה שמתרגמים בעיות מורכבות לפתרונות מדויקים מבוססי דאטה.'
      }
    ].map((p, i) => (
