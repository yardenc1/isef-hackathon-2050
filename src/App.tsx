    ...
    {[
      {
        ...
        desc : 'DS באינטל וחוקר דאטה באוני' תל אביב.מפתח מודלים מתקדמים לקבלת החלטות בעולם האמיתי, תוך עבודה עם דאטה מורכב ולא מושלם.',
      ...
      },
      {
        ...
        name : 'עידן שחמון',
        img : '/images/edan.jpg',
        desc : 'חוקר דאטה באוני' תל אביב. מפתח מודלים מתקדמים ולמידת מכונה בסביבות מחקר ותעשייה.',
